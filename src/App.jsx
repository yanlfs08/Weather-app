...
import inicitialData from './halpers/initialData';

import Card from './components/Card';

function App() {
  const [city, setCity] = useState('');
  const [data, setData] = useState(inicitialData);
  ...
  return (
    <div className="flex flex-col w-full h-screen items-center sm:justify-center justify-center p-4">
